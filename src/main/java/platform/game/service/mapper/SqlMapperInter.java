...
public interface SqlMapperInter {
        ...
        // 로그인 대상 선호 게임 swiper
        @Select("select distinct m.mem_id, m.mem_nick, m.mem_lvl from ranking r join member m on r.mem_id = m.mem_id where r.rank<50 and r.game_cd=#{game_cd} order by rand() limit 4")
