...
public interface SqlMapperInter {
        ...
        @Select("select r.rank, m.mem_userid, round((m.mem_win_count/m.mem_game_count)*100,2) as winrate from ranklist r join member m on r.rank_code=2 and m.mem_id=r.mem_id")
